...
local garages = {
	...
	[9]= { locked = false, camera = {x = 556.52, y = -177.33, z = 56.11, heading = 271.08}, driveout = {x = 554.52, y = -175.33, z = 53.61, heading = 88.46}, drivein = {x = 554.52, y = -175.33, z = 53.61, heading = 271.08}, outside = {x = 554.52, y = -175.33, z = 53.61, heading = 88.46}, inside = {x = 554.52, y = -175.33, z = 53.61, heading = 271.08} },
...
local function DriveInGarage()
	...
	if DoesEntityExist(veh) then
		...
		Citizen.CreateThread(function()
			...
			savedVehicleLockState = GetVehicleDoorLockStatus(veh)
...
local function DriveOutOfGarage(pos)
	Citizen.CreateThread(function()
		...
		SetVehicleOnGroundProperly(veh)
		SetVehicleDoorsLocked(veh, (savedVehicleLockState or 0))
