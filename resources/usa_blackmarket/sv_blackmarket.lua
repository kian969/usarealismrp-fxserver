...
local markets = {
  ['marketA'] = {
    ...
    ['items'] = {
      ...
      { name = "AP Pistol Parts", price = tonumber(tostring(math.random(20, 50)) .. "000"), type = "weaponParts", weight = 15.0, quantity = 1, stock = math.random(0, 1) },
      ...
      { name = "Micro SMG Parts", price = tonumber(tostring(math.random(30, 50)) .. "000"), type = "weaponParts", weight = 30.0, quantity = 1, stock = math.random(0, 1) },
      ...
      { name = "Combat PDW Parts", price = tonumber(tostring(math.random(35, 50)) .. "000"), type = "weaponParts", weight = 25.0, quantity = 1, stock = math.random(0, 2) },
  ...
  ['marketB'] = {
    ...
    ['items'] = {
      ...
      { name = "Machine Pistol Parts", price = tonumber(tostring(math.random(20, 50)) .. "000"), type = "weaponParts", weight = 20.0, quantity = 1, stock = math.random(0, 2) },
  ...
  ['marketC'] = {
    ...
    ['items'] = {
      ...
      { name = "Tommy Gun Parts", price = tonumber(tostring(math.random(40, 75)) .. "000"), type = "weaponParts", weight = 45.0, quantity = 1, stock = math.random(0, 1) },
      ...
      { name = "AK-47 Parts", price = tonumber(tostring(math.random(45, 100)) .. "000"), type = "weaponParts", weight = 45.0, quantity = 1, stock = math.random(0, 1) },
      ...
      { name = "Carbine Parts", price = tonumber(tostring(math.random(45, 100)) .. "000"), type = "weaponParts", weight = 45.0, quantity = 1, stock = math.random(0, 1) },
      ...
      { name = "Compact Rifle Parts", price = tonumber(tostring(math.random(45, 80)) .. "000"), type = "weaponParts", weight = 40.0, quantity = 1, stock = math.random(0, 1) },
      { name = "Military Rifle Parts", price = tonumber(tostring(math.random(50, 100)) .. "000"), type = "weaponParts", weight = 35.0, quantity = 1, stock = math.random(0, 1) },
  ...
  ['marketD'] = {
    ...
    ['items'] = {
      ...
      { name = ".45 Bullets", type = "ammo", price = 675, weight = 0.5, quantity = 10, legality = "legal", objectModel = "prop_ld_ammo_pack_01" },
      { name = "9mm Bullets", type = "ammo", price = 600, weight = 0.5, quantity = 10, legality = "legal", objectModel = "prop_ld_ammo_pack_01" },
      { name = ".50 Cal Bullets", type = "ammo", price = 1000, weight = 0.5, quantity = 10, legality = "legal", objectModel = "prop_ld_ammo_pack_01" },
      { name = "9x18mm Bullets", type = "ammo", price = 600, weight = 0.5, quantity = 10, legality = "legal", objectModel = "prop_ld_ammo_pack_01" },
      { name = "5.56mm Bullets", type = "ammo", price = 1800, weight = 0.5, quantity = 10, legality = "legal", objectModel = "prop_ld_ammo_pack_03"  },
      { name = "7.62mm Bullets", type = "ammo", price = 1200, weight = 0.5, quantity = 10, legality = "legal", objectModel = "prop_ld_ammo_pack_03" },
