webpackJsonp([0], [, , , , , , , function(t, e, n) {
    ...
    var s = n(1),
        ...
        A = function() {
            ...
            return v()(t, [{
                ...
                key: "ontwitter_logout",
                value: function(t) {
                    localStorage.removeItem("gcphone_twitter_username"), localStorage.removeItem("gcphone_twitter_password"), localStorage.removeItem("gcphone_twitter_avatarUrl"), w.a.commit("UPDATE_ACCOUNT", {
                        username: void 0,
                        password: void 0,
                        avatarUrl: void 0
                    })
                    ...
                    return o.a.wrap(function(n) {
                        for (;;) switch (n.prev = n.next) {
                            case 0:
                                s = a()({}, e, {
                                    id: t.currentId++,
                                    duration: parseInt(e.duration) || 5e3
    ...
    function s(t) {
        return t.includes("-") ? t : t.substr(0, 1) + t.substr(1, 1) + t.substr(2, 1) + "-" + t.substr(3, 1) + t.substr(4, 1) + t.substr(5, 1) + t.substr(6, 1)
    }
    Object.defineProperty(e, "__esModule", {
        value: !0
    });
    ...
    e.default = {
        ...
        computed: i()({}, n.i(a.b)(["IntlString", "contacts", "useMouse"])),
        methods: i()({}, n.i(a.a)(["updateContact", "addContact"]), {
            onUp: function() {
            ...
            deleteC: function() {
                this.$phoneAPI.deleteContact(this.contact.deleteName)
            }
        }),
        created: function() {
            var t = this;
    ...
    e.default = {
        ...
        computed: r()({}, n.i(l.b)(["IntlString", "contacts", "useMouse"]), {
            lcontacts: function() {
                return [{
        ...
        methods: {
            onSelect: function(t) {
                var e = this; - 1 === t.num ? p.a.CreateTextModal({
                    title: this.IntlString("APP_PHONE_ENTER_NUMBER"),
                    limit: 10
                }).then(function(t) {
                    var n = t.text.trim();
                    "" !== n && (n = s(n), e.$router.push({
                        name: "messages.view",
                        params: {
                            number: n,
                            display: n
    ...
    e.default = {
        ...
        computed: l()({}, n.i(p.b)(["IntlString", "useMouse", "myPhoneNumber", "backgroundLabel", "coqueLabel", "zoom", "config", "volume", "availableLanguages"]), {
            paramList: function() {
        ...
        methods: l()({}, n.i(p.a)(["getIntlString", "setZoon", "setBackground", "setCoque", "setVolume", "setLanguage", "setMouseSupport"]), {
            scrollIntoViewIfNeeded: function() {
                this.$nextTick(function() {
                    document.querySelector(".select").scrollIntoViewIfNeeded()
                })
                        ...
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return t.ignoreControls = !0, n = t.tweets[t.selectMessage], s = [{
                                    ...
                                    icons: "fa-search"
                                }].concat(a()(s))), e.next = 6, h.a.CreateModal({
                                    choix: s
                                });
                            case 6:
            ...
            reply: function(t) {
                ...
                return c()(o.a.mark(function n() {
                    ...
                    return o.a.wrap(function(n) {
                        for (;;) switch (n.prev = n.next) {
                            case 0:
                                return s = t.author, n.prev = 1, e.ignoreControls = !0, n.next = 5, h.a.CreateTextModal({
                                    title: "Respond",
                                    text: "@" + s + " "
                                });
                            case 5:
        ...
        render: function() {
            ...
            return n("div", {
                ...
                directives: [{
                    name: "model",
                    rawName: "v-model",
                    value: t.contact.deleteName,
                    expression: "contact.deleteName"
                }, {
                    name: "autofocus",
                    rawName: "v-autofocus"
                }],
                ...
                on: {
                    input: function(e) {
                        e.target.composing || t.$set(t.contact, "deleteName", e.target.value)
                    }
                }
            }), t._v(" "), n("span", {
                staticClass: "highlight"
                ...
                staticClass: "bar"
            }), t._v(" "), n("label", [t._v("To delete name")])]), t._v(" "), n("div", {
                staticClass: "group",
                attrs: {
                    "data-type": "button",
                    "data-action": "deleteC"
