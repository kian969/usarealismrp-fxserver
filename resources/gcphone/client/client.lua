...
AddEventHandler("gcPhone:acceptCall", function(infoCall, initiator)
  if inCall == false and USE_RTC == false then
    ...
    exports["mumble-voip"]:addPlayerToRadio(infoCall.id + 300) -- +300 just to avoid conflicting with dispatch radio channels
  end
  if menuIsOpen == false then 
    TooglePhone()
  end
...
AddEventHandler("gcPhone:rejectCall", function(infoCall)
  if inCall == true then
    ...
    exports["mumble-voip"]:removePlayerFromRadio(infoCall.id + 300)
  end
  PhonePlayText()
