...
AddEventHandler("gcphone:send911Message", function(data)
    ...
    if not (msg == nil) then 
    	...
    	TriggerServerEvent('911:PlayerCall', x, y, z, lastStreetNAME, msg, "FMMC_KEY_TIP8")
...
RegisterNUICallback('deleteContact', function(data, cb)
	TriggerServerEvent('gcPhone:deleteContact', data.name)
end)
