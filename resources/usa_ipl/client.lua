...
Citizen.CreateThread(function()
    ...
    FinanceOffice4.Swag.Enable(FinanceOffice4.Painting)
    RefreshInterior(FinanceOffice4.interiorId)

    -- ====================================================================
    -- =-------------------------- [DLC: Bikers] -------------------------=
    -- ====================================================================
    BikerCocaine.LoadDefault(BikerCocaine.Style.basic, true)	        -- Cocaine lockup: 1093.6, -3196.6, -38.99841
    ...
    AfterHoursNightclubs.Interior.Bar.Enable(false, true)
