...
local vehicleShopItems = {
	["vehicles"] = {
		["Suvs"] = {
			...
			--commodity {make = "Gallivanter", model = "Baller LE", price = 47457, hash = 1878062887, storage_capacity = 280.0},
			--commodity {make = "Gallivanter", model = "Baller", price = 25150, hash = 634118882, storage_capacity = 280.0},
			...
			--commodity {make = "Mammoth", model = "Patriot Mil-Spec", price = 81784, hash = "patriot3_USA", storage_capacity = 280.0},
		...
		["Coupes"] = {
			...
			--commodity {make = "Karin", model = "Calico GTF", price = 25000, hash = "calico", storage_capacity = 160.0},
			...
			--commodity {make = "Pfister", model = "Comet 1", price = 34987, hash = -1045541610, storage_capacity = 160.0},
			--commodity {make = "Pfister", model = "Comet 2", price = 46965, hash = -2022483795, storage_capacity = 160.0},
			--commodity {make = "Pfister", model = "Comet 3", price = 62765, hash = "comet5", storage_capacity = 160.0},
			--commodity {make = "Pfister", model = "Comet 4", price = 52765, hash = "comet4", storage_capacity = 160.0},
		...
		["Trucks"] = {
			--commodity {make = "Benefactor", model = "Dubsta 6x6", price = 90897, hash = -1237253773, storage_capacity = 280.0},
			...
			--commodity {make = "Bravado", model = "Rat-Truck", price = 29213, hash =  "ratloader2", storage_capacity = 280.0},
			...
			--commodity {make = "Karin", model = "Hotring Everon", price = 180000, hash =  "everon2", storage_capacity = 120.0}, --Racetruck
			...
			--commodity {make = "Vapid", model = "Guardian", price = 109999, hash =  -2107990196, storage_capacity = 340.0},
		...
		["Compacts"] = {
			...
			--commodity {make = "Grotti", model = "Brioso 300 Widebody", price = 15650, hash = "brioso3", storage_capacity = 160.0},
		...
		["Offroads"] = {
			...
			--commodity {make = "Canis", model = "Kalahari", price = 21888, hash = 92612664, storage_capacity = 280.0},
			{make = "Canis", model = "Mesa", price = 14650, hash = 914654722, storage_capacity = 280.0},
			--commodity {make = "Canis", model = "Mesa 2", price = 27640, hash = -2064372143, storage_capacity = 280.0},
			...
			--commodity {make = "Nagasaki", model = "Hot Rod Blazer", price = 20000, hash = "blazer3", storage_capacity = 30.0},
			...
			--commodity {make = "Vapid", model = "Trophy Truck", price = 60000, hash = 101905590, storage_capacity = 120.0},
			--commodity {make = "Vapid", model = "Trophy Truck 2", price = 100000, hash = -663299102, storage_capacity = 120.0},
		},
		["Motorcycles"] = {
		...
		["Specials"] = {
			...
			--commodity {make = "Progen", model = "Proff (NOT ROAD LEGAL)", price = 250000, hash = "proff", storage_capacity = 60.0},
			...
			--commodity {make = "Voodoo", model = "Caddy S", price = 20000, hash = "voodoo_caddys", storage_capacity = 60.0},
		},
		["Electric"] = {
			...
			--commodity {make = "Pfister", model = "Neon", price = 58674, hash = "neon", storage_capacity = 220.0},
		},
		--[[
		["Custom"] = {
			...
			--commodity {make = "Audi", model = "e-tron GT", price = 140000, hash = "ocnetrongt", storage_capacity = 220.0},
			...
			{make = "BMW", model = "i8", price = 245000, hash = "i8", storage_capacity = 120.0},
			{make = "BMW", model = "M2", price = 165000, hash = "m2", storage_capacity = 180.0},
			{make = "BMW", model = "M3 (E30)", price = 80000, hash = "alpinae30", storage_capacity = 180.0},
			{make = "BMW", model = "M3 (E46)", price = 80000, hash = "m3e46", storage_capacity = 180.0},
			{make = "BMW", model = "M3 (E92)", price = 135000, hash = "bmwm3e92", storage_capacity = 180.0},
			{make = "BMW", model = "M3 GTS (E92)", price = 190000, hash = "m3e92gts", storage_capacity = 180.0},
			{make = "BMW", model = "M4 (F82)", price = 180000, hash = "f82st", storage_capacity = 220.0},
			{make = "BMW", model = "M4 Widebody (F82)", price = 190000, hash = "f82lw", storage_capacity = 220.0},
			{make = "BMW", model = "M4 (G82)", price = 250000, hash = "m422", storage_capacity = 200.0},
			{make = "BMW", model = "M5 (E34)", price = 90000, hash = "e34", storage_capacity = 220.0},
			{make = "BMW", model = "M5 (E60)", price = 150000, hash = "m5e60", storage_capacity = 220.0},
			{make = "BMW", model = "M5", price = 170000, hash = "bmci", storage_capacity = 220.0},
			...
			{make = "BMW", model = "X5 M (2016)", price = 160000, hash = "X5M2016", storage_capacity = 300.0},
			{make = "BMW", model = "Z3 M Coupe", price = 80000, hash = "z3", storage_capacity = 160.0},
			--
			...
			{make = "Chevrolet", model = "Camaro ZL1", price = 120000, hash = "vanzczl1", storage_capacity = 180.0},
			...
			--commodity {make = "Chevrolet", model = "Camaro SS (1969)", price = 70000, hash = "camaro69", storage_capacity = 180.0},
			--commodity {make = "Chevrolet", model = "Camaro Z28 (1970)", price = 80000, hash = "camaro70", storage_capacity = 180.0},
			...
			{make = "Chevrolet", model = "Corvette C6 ZR1", price = 100000, hash = "vanzc6zr1", storage_capacity = 180.0},
			{make = "Chevrolet", model = "Corvette C7", price = 95000, hash = "c7", storage_capacity = 160.0},
			--commodity {make = "Chevrolet", model = "Corvette C7R GTLM (NOT ROAD LEGAL)", price = 210000, hash = "C7R", storage_capacity = 120.0},
			...
			{make = "Chrysler", model = "300 WB", price = 120000, hash = "vanz300ws", storage_capacity = 220.0},
			...
			{make = "Dodge", model = "Charger Daytona", price = 150000, hash = "vanzdchar", storage_capacity = 180.0},
			...
			--commodity {make = "Dodge", model = "Hellephant Durango", price = 190000, hash = "hellephantdurango", storage_capacity = 280.0},
			...
			--commodity {make = "Dodge", model = "Viper (2016)", price = 300000, hash = "viper", storage_capacity = 120.0},
			--commodity {make = "Dodge", model = "Viper ACR (2016)", price = 350000, hash = "acr", storage_capacity = 120.0},
			--
			{make = "Ducati", model = "Panigale", price = 90000, hash = "panigale", storage_capacity = 30.0},
			--
			--commodity {make = "Ferrari", model = "458 LW", price = 950000, hash = "lw458s", storage_capacity = 120.0},
			{make = "Ferrari", model = "California (1957)", price = 600000, hash = "cali57", storage_capacity = 120.0},
			--commodity {make = "Ferrari", model = "F8 Tributo", price = 850000, hash = "f8t", storage_capacity = 120.0},
			...
			--commodity {make = "Ferrari", model = "FXXK (NOT ROAD LEGAL)", price = 2400000, hash = "fxxk", storage_capacity = 120.0},
			--commodity {make = "Ferrari", model = "LaFerrari", price = 1500000, hash = "laferrari", storage_capacity = 120.0},
			--
			...
			--commodity {make = "Ford", model = "Mustang Boss Widebody (1970)", price = 130000, hash = "rr70bosswide", storage_capacity = 180.0},
			...
			--
			--commodity {make = "GMC", model = "CadimaX 3500HD (2018)", price = 150000, hash = "GODzBGDCADIMAX", storage_capacity = 300.0},
			...
			--
			--commodity {make = "Italdesign", model = "GTR50", price = 2000000, hash = "rmodgtr50", storage_capacity = 120.0},
			--
			...
			--commodity {make = "Lamborghini", model = "Essenza (NOT ROAD LEGAL)", price = 2800000, hash = "rmodessenza", storage_capacity = 120.0},
			{make = "Lamborghini", model = "Gallardo LW", price = 450000, hash = "GallardoLW", storage_capacity = 120.0},
			--commodity {make = "Lamborghini", model = "Huracan Evo 2 (2022) (NOT ROAD LEGAL)", price = 1800000, hash = "evo2", storage_capacity = 120.0},
			...
			--
			--commodity {make = "Mclaren", model = "600LT", price = 500000, hash = "600lt", storage_capacity = 120.0},
			{make = "Mclaren", model = "Elva", price = 2300000, hash = "elva", storage_capacity = 120.0},
			--commodity {make = "Mclaren", model = "P1", price = 1600000, hash = "p1", storage_capacity = 120.0},
			--commodity {make = "Mclaren", model = "P1 GTR", price = 1900000, hash = "rmodp1gtr", storage_capacity = 120.0},
			{make = "Mclaren", model = "Senna", price = 2000000, hash = "sennas", storage_capacity = 120.0},
			--commodity {make = "Mclaren", model = "Senna GTR (NOT ROAD LEGAL)", price = 2200000, hash = "sennasgtr", storage_capacity = 120.0},
			--
			...
			--commodity {make = "Mercedes-Benz", model = "AMG GT", price = 500000, hash = "rr20amggt", storage_capacity = 120.0},
			...
			--commodity {make = "Mercedes-Benz", model = "CLK LM (NOT ROAD LEGAL)", price = 2600000, hash = "clklm", storage_capacity = 120.0},
			--
			...
			--commodity {make = "Nissan", model = "R32 GTR", price = 160000, hash = "r32", storage_capacity = 160.0},
			...
			--
			--commodity {make = "Pagani", model = "Zonda R (NOT ROAD LEGAL)", price = 3000000, hash = "zondar", storage_capacity = 120.0},
			--
			...
			--commodity {make = "Porsche", model = "918", price = 1400000, hash = "918", storage_capacity = 120.0},
			...
			--commodity {make = "Toyota", model = "Supra (Castrol) (NOT ROAD LEGAL)", price = 800000, hash = "castrolsupra", storage_capacity = 120.0},
			--
