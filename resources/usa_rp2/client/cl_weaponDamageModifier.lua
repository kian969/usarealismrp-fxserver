...
local WEAPON_DAMAGE_MODIFIERS = {
  ...
  [`WEAPON_MACHINEPISTOL`] = 0.9,
  [`WEAPON_MICROSMG`] = 1.0,
  [`WEAPON_SMG`] = 1.0,
  [`WEAPON_SCARSC`] = 0.6,
  [`WEAPON_COMBATPDW`] = 1.1,
  [`WEAPON_ASSAULTSMG`] = 1.2,
  [`WEAPON_MINISMG`] = 1.0,
  [`WEAPON_SMG_MK2`] = 1.1,
  [`WEAPON_GUSENBERG`] = 0.9,
  [`WEAPON_COMPACTRIFLE`] = 0.55,
  [`WEAPON_ASSAULTRIFLE`] = 0.6,
  [`WEAPON_ASSAULTRIFLE_MK2`] = 0.65,
