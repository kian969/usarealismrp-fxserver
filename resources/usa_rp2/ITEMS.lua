local ITEMS = {
    ...
    { name = "Fruit Tart", price = 30, type = "food", substance = 40.0, quantity = 1, legality = "legal", weight = 1, objectModel = "prop_food_burg1"},
    ...
    { name = "Weepy Cupcake", price = 65, type = "food", substance = 65.0, quantity = 1, legality = "legal", weight = 2, objectModel = "prop_food_burg2"},
    { name = "Moon Mochi", price = 45, type = "food", substance = 35.0, quantity = 1, legality = "legal", weight = 1, objectModel = "prop_food_burg2"},
    ...
    { name = "Bento Box", price = 120, type = "food", substance = 100.0, quantity = 1, legality = "legal", weight = 3, objectModel = "prop_food_cb_nugets"},
    ...
    { name = "Espresso", price = 30, type = "drink", substance = 55.0, quantity = 1, legality = "legal", weight = 1, objectModel = "p_amb_coffeecup_01"},
    { name = "Macchiato", price = 35, type = "drink", substance = 60.0, quantity = 1, legality = "legal", weight = 1, objectModel = "v_res_mcofcup"},
    { name = "Latte", price = 40, type = "drink", substance = 75.0, quantity = 1, legality = "legal", weight = 1, objectModel = "v_res_mcofcup"},
    { name = "Mocha", price = 50, type = "drink", substance = 80.0, quantity = 1, legality = "legal", weight = 2, objectModel = "v_res_mcofcup"},
