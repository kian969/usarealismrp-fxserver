...
SecurityCamConfig.Locations = {
    ...
    },
    {
        ...
        cameras = {
            -- Cafeteria
            {label = "Kitchen Cam", x = 1775.4255371094, y = 2591.0290527344, z = 48.197798919678, r = {x = -25.0, y = 0.0, z = 318.0}},
            {label = "Storage", x = 1779.8646240234, y = 2599.6398925781, z = 47.897832489014, r = {x = -25.0, y = 0.0, z = 234.0}}
        }
    },
    {
    ...
    },
    {
        ...
        cameras = {
            ...
            {label = "Reception", x = 299.36981201172, y = -588.18414306641, z = 45.507614135742, r = {x = -25.0, y = 0.0, z = 298.0}},
            {label = "Elevator Hallway", x = 331.17337036133, y = -598.81555175781, z = 45.553147888184, r = {x = -25.0, y = 0.0, z = 26.0}},
            {label = "Ward A", x = 305.70223999023, y = -570.11065673828, z = 45.196933746338, r = {x = -25.0, y = 0.0, z = 210.0}},
            {label = "Ward A ER RM", x = 329.62728881836, y = -589.9658203125, z = 45.487609863281, r = {x = -25.0, y = 0.0, z = 34.0}},
            {label = "Ward C Entrance", x = 338.79772949219, y = -581.98187255859, z = 45.3076171875, r = {x = -25.0, y = 0.0, z = 228.0}},
            {label = "Ward C Side", x = 345.22686767578, y = -601.14221191406, z = 45.247615814209, r = {x = -25.0, y = 0.0, z = 329.0}},
        }
    },
    {
