...
AddEventHandler("core_rob_truck:hint", function()
	...
	local GreatOceanHint = "^0[^5Terminal At Risk^0] The exterior of the Bank on Great Ocean Highway near Chumash. The terminal company is BLICK and is located [^9REDACTED^0]"
