...
supportedVehicles = {
    ...
    { name = "BMW 1100R Street Fighter", model = "BMW1100R", class = "M" },
    ...
    { name = "Kawasaki H2R", model = "ninjah2", class = "M" },
    { name = "Kawasaki Z1000", model = "z1000", class = "M" },
    { name = "Ducati Panigale", model = "panigale", class = "M" },
    { name = "Yamaha R1", model = "yamahar1", class = "M" },
    ...
    { name = "2018 Harley Davidson FLHXS", model = "flhxs_streetglide_special18", class = "M" },
    { name = "Harley Davidson Road King", model = "na25", class = "M" },
    { name = "2022 Sur Ron Lightbee Pxx", model = "22Surron", class = "M" },
