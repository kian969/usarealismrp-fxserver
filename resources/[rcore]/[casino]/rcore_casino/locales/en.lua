Translation["en"] = {
    ...
    BLACKJACK_RULES_PART3 = "Double Down\n\nAfter a player has been dealt their two initial cards, they can double their bet in return for one additional card. This is also avaialble on both hands after splitting.\n",
    ...
    BAR_DRINKS_UNLOCKED = "Enjoy free drinks available at the drinking bar. The offer will expire in 24 hours.",
    ...
    RESTRICTED_AREA = "This is a restricted area, only available for VIP members. Purchase VIP at the Cashier to enter VIP areas or play High Stake tables.",
    ...
    available_SOCIETY_BALANCE = "Society balance: %s",
