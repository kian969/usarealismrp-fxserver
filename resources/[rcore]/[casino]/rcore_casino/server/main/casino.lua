...
TriggerEvent('es:addCommand', 'casinoveh', function(source, args, char)
    TriggerClientEvent("casino:setCasinoVeh", source)
end, {
    help = "Update casino lucky wheel prize vehicle (for casino owner)",
    params = {}
})