...
Config.Shops = {
    [1] = {
        ...
        registerMoney = {1000, 7000}, --The money you can get from the register, from low to high.
        safeCoords = vector3(-43.92, -1748.08, 29.42),
        safeMoney = {2500, 20000}, --The money you can get from the safe, from low to high.
