...
DP.Shared = {
   ...
   ["headonlap"] = {"tigerle@custom@couple@cuddle1a", "tigerle_couple_cuddle1a", "headonlap", "layheadonpartner", AnimationOptions =
    {
        EmoteMoving = false,
        EmoteLoop = true,
        Atatchto = true,
    ...
    ["bigspoon"] = {"tigerle@custom@couple@cuddle@no5a", "tigerle_couple_base_a", "bigspoon", "littlespoon", AnimationOptions =
    {
        EmoteMoving = false,
        EmoteLoop = true,
        Atatchto = true,
    ...
    ["littlespoon"] = {"tigerle@custom@couple@cuddle@no5b", "tigerle_couple_base_b", "littlespoon", "bigspoon", AnimationOptions =
    {
        EmoteMoving = false,
        EmoteLoop = true,
        Atatchto = true,
    ...
    ["partneronlap2"] = {"tigerle@custom@couple@cuddle@no6", "tigerle_couple_cuddle_m", "partneronlap2", "sitonpartnerlap2", AnimationOptions =
    {
        EmoteMoving = false,
        EmoteLoop = true,
        Atatchto = true,
    ...
    ["sitonpartnerlap2"] = {"tigerle@custom@couple@cuddle@no6", "tigerle_couple_cuddle_f", "sitonpartnerlap2", "partneronlap2", AnimationOptions =
    {
        EmoteMoving = false,
        EmoteLoop = true,
        Atatchto = true,
    ...
    ["cuddle"] = {"tigerle@custom@couple@cuddle@no7", "tigerle_couple_cuddle_m", "cuddle", "cuddle2", AnimationOptions =
    {
        EmoteMoving = false,
        EmoteLoop = true,
        Atatchto = true,
    ...
    ["cuddle2"] = {"tigerle@custom@couple@cuddle@no7", "tigerle_couple_cuddle_f", "cuddle2", "cuddle", AnimationOptions =
    {
        EmoteMoving = false,
        EmoteLoop = true,
        Atatchto = true,
